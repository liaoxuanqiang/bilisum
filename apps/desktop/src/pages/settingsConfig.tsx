...
export const settingsCategories: Array<{
  ...
  { id: "performance", label: "性能与资源", description: "并发、CUDA 版本和运行时通道。", group: "system", icon: <SlidersIcon /> },
  ...
  { id: "runtime", label: "运行时", description: "检查并维护 Python、Torch、CUDA、ASR 与扩展依赖。", group: "system", icon: <MonitorIcon /> },
